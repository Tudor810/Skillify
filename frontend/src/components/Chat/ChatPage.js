...
export default function ChatPage({width}) {
  ...
  return (
   data && <div className='chat-page'>
        <Helmet>
          <link rel="canonical" href="https://skillify-ai.com/chat" />
        </Helmet>
        ...
        {location.pathname === "/chat" && <ChatSection />}
        {location.pathname.includes("/chat/") && <OpenThread />}
    </div>
  )
}
